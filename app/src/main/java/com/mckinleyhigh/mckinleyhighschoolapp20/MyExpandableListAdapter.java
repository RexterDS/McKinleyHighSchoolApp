...
public class MyExpandableListAdapter implements ExpandableListAdapter {
    ...
    public int getChildrenCount(int groupPosition) {
        ArrayList<ChildItemsInfo> productList = teamName.get(groupPosition).getMonthName();
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        heading.setText(headerInfo.getMonth().trim());
        return convertView;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        */
        ImageView childItem = (ImageView) convertView.findViewById(R.id.childItem);
        childItem.setImageDrawable(detailInfo.getMenu());
        return convertView;
    }
